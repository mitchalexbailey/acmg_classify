##Fetch gene/variant info
##In Progress, not functional
##Mitch Bailey 01/20/2018

#single input
##gene (optional)
##transcript (or gene, then fetch list of transcripts)
##coding position change or genomic change

#batch input
##csv, line separated per variant
##gene, transcript (required),

#intermediate variables
##nonsense
##frameshift
##changes at the same amino acid position
##in a splice site

#likely not able to automate
##functional studies available

#not able to automate
##patients phenotype/family history strongly suggests single gene etiology

#search myvariant for any available info (classified elsewhere)
#pull sequence info from ucsc, use exon borders to figure out if splice affecting or not
#pull sequence from ucsc, alter and translate (nonsense/frameshift)
#pull pubmed articles mentioning the variant if available (API?)

#function for each possible piece of evidence, return t/f ()
